                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.roles.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" rows="3">{{ old('description') }}</textarea>
