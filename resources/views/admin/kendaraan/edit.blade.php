                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.kendaraan.update', $kendaraan) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('nama', $kendaraan->nama) }}" required>
                            @error('nama')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nomor_plat" id="nomor_plat" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('nomor_plat', $kendaraan->nomor_plat) }}" required>
                            @error('nomor_plat')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="jenis" id="jenis" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('jenis', $kendaraan->jenis) }}" required>
                            @error('jenis')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="kapasitas" id="kapasitas" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('kapasitas', $kendaraan->kapasitas) }}" min="1" required>
                            @error('kapasitas')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
