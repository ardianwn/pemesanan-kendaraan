    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.driver.index')" :active="request()->routeIs('admin.driver.*')">
                    {{ __('Driver') }}
                </x-responsive-nav-link>
            ...
            @elseif(Auth::user()->role === 'approver')
                <x-responsive-nav-link :href="route('approver.dashboard')" :active="request()->routeIs('approver.dashboard')">
                    {{ __('Approver Panel') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('approver.persetujuan.index')" :active="request()->routeIs('approver.persetujuan.*')">
                    {{ __('Persetujuan') }}
                </x-responsive-nav-link>
            @endif
            @if(!Auth::user()->role || Auth::user()->role === 'user')
